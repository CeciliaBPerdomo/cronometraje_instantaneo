function TripleCorona() {
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col items-center px-4 pt-6">
      ...
      >
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="block rounded-2xl border border-orange-200 bg-white p-6 text-center shadow-md transition-transform duration-200 hover:-translate-y-1.5 hover:shadow-xl"
        >
